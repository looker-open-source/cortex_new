- dashboard: order_fulfillment
  ...
  - title: OTIF%
    ...
    dynamic_fields: [{args: [data_intelligence_otc.count], calculation_type: percent_of_column_sum,
      ...
      {args: [data_intelligence_otc.count_of_deliveries], calculation_type: percent_of_column_sum,
        category: table_calculation, based_on: data_intelligence_otc.count_of_deliveries,
        label: Percent of Data Intelligence Otc Count of Deliveries, source_field: data_intelligence_otc.count_of_deliveries,
        table_calculation: percent_of_data_intelligence_otc_count_of_deliveries, value_format: !!null '',
        value_format_name: percent_0, _kind_hint: measure, _type_hint: number, is_disabled: true}]
  ...
  - title: On Time, In Full & OTIF
    ...
    fields: [data_intelligence_otc.count_on_time_delivery, data_intelligence_otc.count_in_full_delivery,
      ...
      data_intelligence_otc.count_of_deliveries]
    ...
    dynamic_fields: [{measure: count_of_delivery, based_on: data_intelligence_otc.delivery,
        ...
        _type_hint: number}, {category: table_calculation, expression: "${data_intelligence_otc.count_on_time_delivery}/${data_intelligence_otc.count_of_deliveries}",
        ...
        expression: "${data_intelligence_otc.count_in_full_delivery}/${data_intelligence_otc.count_of_deliveries}",
        ...
        expression: "${data_intelligence_otc.count_otif}/${data_intelligence_otc.count_of_deliveries}",
    ...
    hidden_fields: [data_intelligence_otc.count_on_time_delivery, data_intelligence_otc.count_in_full_delivery,
      data_intelligence_otc.count_otif, data_intelligence_otc.count_of_deliveries]
    listen:
      Currency Required: data_intelligence_otc.Currency_Required
      Region: data_intelligence_otc.country
      Sales Org: data_intelligence_otc.sales_org
  ...
  - title: Avg Order To Delivery Cycle Time
    ...
    sorts: [average_of_order_cycle_time_in_days desc]
    limit: 500
    ...
    y_axes: [{label: Avg Order Cycle Time(days), orientation: left, series: [{axisId: average_of_order_cycle_time_in_days,
            id: average_of_order_cycle_time_in_days, name: Average of Order Cycle
              Time In Days}], showLabels: true, showValues: true, valueFormat: '',
        unpinAxis: false, tickDensity: default, tickDensityCustom: 5, type: linear}]
  ...
  - title: In Full%
    ...
    dynamic_fields: [{args: [data_intelligence_otc.count], calculation_type: percent_of_column_sum,
      ...
      {category: table_calculation, label: Percent of Data Intelligence Otc Count
          of Deliveries, value_format: !!null '', value_format_name: percent_2, calculation_type: percent_of_column_sum,
        table_calculation: percent_of_data_intelligence_otc_count_of_deliveries, args: [
          data_intelligence_otc.count_of_deliveries], _kind_hint: measure, _type_hint: number,
        is_disabled: true}]
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
  ...
  - title: On Time%
    ...
    dynamic_fields: [{args: [data_intelligence_otc.count], calculation_type: percent_of_column_sum,
      ...
      {category: table_calculation, label: Percentage of Column, value_format: !!null '',
        ...
        _kind_hint: measure, _type_hint: number, is_disabled: true}, {args: [data_intelligence_otc.count_of_deliveries],
        calculation_type: percent_of_column_sum, category: table_calculation, based_on: data_intelligence_otc.count_of_deliveries,
        label: Percent of Data Intelligence Otc Count of Deliveries, source_field: data_intelligence_otc.count_of_deliveries,
        table_calculation: percent_of_data_intelligence_otc_count_of_deliveries, value_format: !!null '',
        value_format_name: percent_0, _kind_hint: measure, _type_hint: number, is_disabled: true}]
    custom_color_enabled: true
